...
<Tip>
AngelHub allows you to upload documents that are accessible to all angels involved in your project.  This negates the need for a separate data room.
</Tip>

## The data room

The Project Lead will ask you to share documents through the AngelHub data room. The data room gives investors secure, controlled access to sensitive documents without them being sent by email.

Organise your data room with documents that describe the following:
